...
import { Shield, ArrowLeft, Mail, Phone, Building } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-white border border-slate-300 rounded-3xl p-6 sm:p-10 space-y-8 text-slate-900 text-sm leading-relaxed shadow-xl">
          <section className="space-y-3">
            <h2 className="text-lg font-black text-slate-950 border-b border-slate-300 pb-2 flex items-center gap-2">
              1. Giới Thiệu Về YumNetwork CRM
            </h2>
            <p className="text-slate-800 font-semibold leading-relaxed">
              Chào mừng bạn đến với <strong className="text-slate-950 font-black">YumNetwork CRM</strong> (thuộc sở hữu của <strong className="text-slate-950 font-black">CÔNG TY TNHH TRUYỀN THÔNG YUM NETWORK</strong>). Chúng tôi tôn trọng quyền riêng tư của bạn và cam kết bảo vệ dữ liệu cá nhân của người dùng, khách hàng cũng như dữ liệu được đồng bộ thông qua các nền tảng của Meta (Facebook Messenger, Lead Ads, Instagram và WhatsApp Business API).
            </p>
            <p className="text-slate-800 font-semibold leading-relaxed">
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pl-6 space-y-2 text-slate-800 font-semibold">
              <li><strong className="text-slate-950 font-black">Thông tin hồ sơ công khai:</strong> Họ tên, ID người dùng Facebook (User ID), ảnh đại diện (khi bạn đăng nhập bằng Facebook OAuth).</li>
              <li><strong className="text-slate-950 font-black">Dữ liệu Fanpage &amp; Messenger:</strong> ID Trang Facebook, nội dung tin nhắn gửi/nhận giữa người dùng và Fanpage để tư vấn viên phản hồi trên YumNetwork CRM.</li>
              <li><strong className="text-slate-950 font-black">Dữ liệu Khách hàng tiềm năng (Facebook Lead Ads):</strong> Họ tên, Số điện thoại, Email, Câu hỏi khảo sát mà khách hàng tự nguyện điền vào Form quảng cáo trên Facebook.</li>
              <li><strong className="text-slate-950 font-black">Dữ liệu WhatsApp Business:</strong> Số điện thoại, trạng thái tin nhắn gửi/nhận phục vụ quy trình chăm sóc tự động.</li>
            </ul>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-slate-800 font-semibold leading-relaxed">Dữ liệu thu thập chỉ được dùng cho các mục đích hợp pháp sau:</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div className="bg-slate-100 p-4 rounded-2xl border border-slate-300">
                <h4 className="font-black text-slate-950 text-xs uppercase tracking-wider mb-1">Quản lý Khách hàng Tập trung</h4>
                <p className="text-xs text-slate-800 font-semibold">Hiển thị danh sách Lead, tạo đơn hàng và theo dõi tiến trình chăm sóc khách hàng.</p>
              </div>
              <div className="bg-slate-100 p-4 rounded-2xl border border-slate-300">
                <h4 className="font-black text-slate-950 text-xs uppercase tracking-wider mb-1">Tự động hóa Messaging</h4>
                <p className="text-xs text-slate-800 font-semibold">Gửi tin nhắn phản hồi tự động, thông báo đơn hàng và nhắc lịch chăm sóc hậu mãi.</p>
              </div>
              <div className="bg-slate-100 p-4 rounded-2xl border border-slate-300">
                <h4 className="font-black text-slate-950 text-xs uppercase tracking-wider mb-1">Báo cáo &amp; Phân tích</h4>
                <p className="text-xs text-slate-800 font-semibold">Thống kê hiệu quả chiến dịch quảng cáo và doanh số của từng nhân viên Telesales.</p>
              </div>
              <div className="bg-slate-100 p-4 rounded-2xl border border-slate-300">
                <h4 className="font-black text-slate-950 text-xs uppercase tracking-wider mb-1">Hỗ trợ Kỹ thuật</h4>
                <p className="text-xs text-slate-800 font-semibold">Giải quyết sự cố kết nối Webhook API và bảo đảm tính an toàn hệ thống.</p>
              </div>
            </div>
          </section>
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pl-6 space-y-1.5 text-slate-800 font-semibold">
          ...
          <section className="space-y-3">
            ...
            <p className="text-slate-800 font-semibold leading-relaxed">
              ...
              <a href="#data-deletion" className="text-red-600 underline font-black hover:text-red-700">
          ...
          <section className="space-y-3 pt-4 border-t border-slate-300">
            ...
            <div className="bg-slate-100 p-4 rounded-2xl border border-slate-300 space-y-2 text-xs">
              <div className="flex items-start gap-2 text-slate-900 font-bold">
                <Building className="w-4 h-4 text-red-600 shrink-0 mt-0.5" />
                <span><strong className="text-slate-950 font-black">Đơn vị chủ quản:</strong> CÔNG TY TNHH TRUYỀN THÔNG YUM NETWORK</span>
              </div>
              <div className="flex items-start gap-2 text-slate-900 font-bold">
                <Building className="w-4 h-4 text-red-600 shrink-0 mt-0.5" />
                <span><strong className="text-slate-950 font-black">Trụ sở chính:</strong> Tầng 1, Tòa nhà Dreamland Bonanza, 23 Duy Tân, Phường Cầu Giấy, Thành phố Hà Nội, Việt Nam</span>
              </div>
              ...
              <div className="flex items-center gap-2 text-slate-900 font-bold">
                ...
                <span><strong className="text-slate-950 font-black">Hotline hỗ trợ:</strong> 0985 601 051</span>
              </div>
            </div>
          </section>
        </div>
